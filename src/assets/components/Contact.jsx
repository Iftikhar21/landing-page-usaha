            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div>
                        ...
                        <p class="text-gray-600 mb-8">Tim kami siap membantu Anda memilih template yang tepat sesuai
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">hello@eduxpace.com</p>
                                </div>
                            </div>
                            <div class="flex items-center">
                    ...
                    <div class="bg-accent p-8 rounded-xl">
                        <form class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-900 mb-2">Jenis Template</label>
                                <select
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-300">
                                    <option>Pilih jenis template</option>
                                    <option>Template Edukasi</option>
                                    <option>Template Bisnis</option>
                                    <option>Template Portfolio</option>
                                    <option>Template E-Learning</option>
